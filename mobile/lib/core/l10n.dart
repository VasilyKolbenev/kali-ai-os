...
class L10n {
  ...
  String get useWithoutComputer => _t({'ru': '\u0418\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u044c \u0431\u0435\u0437 \u043a\u043e\u043c\u043f\u044c\u044e\u0442\u0435\u0440\u0430', 'en': 'Use without a computer', 'es': 'Usar sin ordenador', 'zh': '\u65e0\u9700\u7535\u8111\u4f7f\u7528', 'de': 'Ohne Computer verwenden'});
  ...
  String importedStandalone(String name) => _t({'ru': '\u0410\u0433\u0435\u043d\u0442 \u00ab$name\u00bb \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d \u0432 \u00ab\u041c\u043e\u0438 \u0430\u0433\u0435\u043d\u0442\u044b\u00bb', 'en': 'Agent \u201c$name\u201d added to \u201cMy agents\u201d', 'es': 'Agente \u00ab$name\u00bb a\u00f1adido a \u00abMis agentes\u00bb', 'zh': '\u667a\u80fd\u4f53\u300c$name\u300d\u5df2\u6dfb\u52a0\u5230\u300c\u6211\u7684\u667a\u80fd\u4f53\u300d', 'de': 'Agent \u201e$name\u201c zu \u201eMeine Agenten\u201c hinzugef\u00fcgt'});
  ...
  // ── Import consent (kali://import asks before installing an untrusted agent) ──
  String get importConfirmTitle => _t({'ru': 'Установить агента?', 'en': 'Install this agent?', 'es': '¿Instalar este agente?', 'zh': '安装此智能体？', 'de': 'Diesen Agenten installieren?'});
  String importConfirmBody(String name) => _t({'ru': 'Кто-то поделился с тобой агентом «$name». Он будет добавлен на твой телефон.', 'en': 'Someone shared the agent “$name” with you. It will be added to your phone.', 'es': 'Alguien compartió el agente «$name» contigo. Se añadirá a tu teléfono.', 'zh': '有人与你分享了智能体「$name」。它将被添加到你的手机。', 'de': 'Jemand hat den Agenten „$name“ mit dir geteilt. Er wird zu deinem Telefon hinzugefügt.'});
  String get importConfirmInstall => _t({'ru': 'Установить', 'en': 'Install', 'es': 'Instalar', 'zh': '安装', 'de': 'Installieren'});
  String get importConfirmCancel => _t({'ru': 'Отмена', 'en': 'Cancel', 'es': 'Cancelar', 'zh': '取消', 'de': 'Abbrechen'});
  ...
  // ── Generic ──
  String get llmSettingsTitle => _t({'ru': '\u041a\u043b\u044e\u0447 \u043a AI', 'en': 'AI key', 'es': 'Clave de IA', 'zh': 'AI \u5bc6\u94a5', 'de': 'KI-Schl\u00fcssel'});
  String get llmProviderLabel => _t({'ru': '\u041f\u0440\u043e\u0432\u0430\u0439\u0434\u0435\u0440 AI', 'en': 'AI provider', 'es': 'Proveedor de IA', 'zh': 'AI \u63d0\u4f9b\u5546', 'de': 'KI-Anbieter'});
  String get llmApiKeyLabel => _t({'ru': 'API-\u043a\u043b\u044e\u0447', 'en': 'API key', 'es': 'Clave API', 'zh': 'API \u5bc6\u94a5', 'de': 'API-Schl\u00fcssel'});
  String get llmKeyHelper => _t({'ru': '\u041a\u043b\u044e\u0447 \u043a \u0442\u0432\u043e\u0435\u0439 AI-\u043c\u043e\u0434\u0435\u043b\u0438. \u0425\u0440\u0430\u043d\u0438\u0442\u0441\u044f \u0442\u043e\u043b\u044c\u043a\u043e \u043d\u0430 \u0442\u0435\u043b\u0435\u0444\u043e\u043d\u0435.', 'en': 'Your AI model key. Stored only on this phone.', 'es': 'Tu clave del modelo de IA. Se guarda solo en este tel\u00e9fono.', 'zh': '\u4f60\u7684 AI \u6a21\u578b\u5bc6\u94a5\u3002\u4ec5\u4fdd\u5b58\u5728\u672c\u624b\u673a\u4e0a\u3002', 'de': 'Dein KI-Modell-Schl\u00fcssel. Wird nur auf diesem Telefon gespeichert.'});
  String get llmKeySaved => _t({'ru': '\u041a\u043b\u044e\u0447 \u0441\u043e\u0445\u0440\u0430\u043d\u0451\u043d', 'en': 'Key saved', 'es': 'Clave guardada', 'zh': '\u5bc6\u94a5\u5df2\u4fdd\u5b58', 'de': 'Schl\u00fcssel gespeichert'});
  String get llmKeyEmpty => _t({'ru': '\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043a\u043b\u044e\u0447 \u2014 \u043f\u0443\u0441\u0442\u043e\u0435 \u043f\u043e\u043b\u0435 \u043d\u0435 \u0441\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c', 'en': 'Enter a key \u2014 empty is not saved', 'es': 'Introduce una clave \u2014 vac\u00edo no se guarda', 'zh': '\u8bf7\u8f93\u5165\u5bc6\u94a5 \u2014 \u7a7a\u503c\u4e0d\u4f1a\u4fdd\u5b58', 'de': 'Schl\u00fcssel eingeben \u2014 leer wird nicht gespeichert'});
  String get llmAddKeyCta => _t({'ru': '\u0414\u043e\u0431\u0430\u0432\u044c \u043a\u043b\u044e\u0447 \u043a AI, \u0447\u0442\u043e\u0431\u044b \u043d\u0430\u0447\u0430\u0442\u044c', 'en': 'Add your AI key to start', 'es': 'A\u00f1ade tu clave de IA para empezar', 'zh': '\u6dfb\u52a0 AI \u5bc6\u94a5\u5373\u53ef\u5f00\u59cb', 'de': 'F\u00fcge deinen KI-Schl\u00fcssel hinzu, um zu starten'});
  String get llmErrorNetwork => _t({'ru': '\u041d\u0435\u0442 \u0441\u0435\u0442\u0438. \u041f\u0440\u043e\u0432\u0435\u0440\u044c \u043f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u0435 \u0438 \u043f\u043e\u043f\u0440\u043e\u0431\u0443\u0439 \u0441\u043d\u043e\u0432\u0430.', 'en': 'No network. Check your connection and try again.', 'es': 'Sin red. Verifica tu conexi\u00f3n e int\u00e9ntalo de nuevo.', 'zh': '\u65e0\u7f51\u7edc\u3002\u8bf7\u68c0\u67e5\u8fde\u63a5\u540e\u91cd\u8bd5\u3002', 'de': 'Kein Netzwerk. Pr\u00fcfe deine Verbindung und versuche es erneut.'});
  String get llmErrorApi => _t({'ru': 'AI \u0432\u0435\u0440\u043d\u0443\u043b \u043e\u0448\u0438\u0431\u043a\u0443. \u041f\u0440\u043e\u0432\u0435\u0440\u044c \u043a\u043b\u044e\u0447 \u0438 \u043f\u043e\u043f\u0440\u043e\u0431\u0443\u0439 \u0441\u043d\u043e\u0432\u0430.', 'en': 'The AI returned an error. Check your key and try again.', 'es': 'La IA devolvi\u00f3 un error. Verifica tu clave e int\u00e9ntalo de nuevo.', 'zh': 'AI \u8fd4\u56de\u9519\u8bef\u3002\u8bf7\u68c0\u67e5\u5bc6\u94a5\u540e\u91cd\u8bd5\u3002', 'de': 'Die KI hat einen Fehler zur\u00fcckgegeben. Pr\u00fcfe deinen Schl\u00fcssel und versuche es erneut.'});
  String get llmErrorQuota => _t({'ru': '\u041b\u0438\u043c\u0438\u0442 \u0437\u0430\u043f\u0440\u043e\u0441\u043e\u0432 \u0438\u0441\u0447\u0435\u0440\u043f\u0430\u043d. \u041f\u043e\u043f\u0440\u043e\u0431\u0443\u0439 \u043f\u043e\u0437\u0436\u0435.', 'en': 'Request limit reached. Try again later.', 'es': 'L\u00edmite de solicitudes alcanzado. Int\u00e9ntalo m\u00e1s tarde.', 'zh': '\u8bf7\u6c42\u5df2\u8fbe\u4e0a\u9650\u3002\u8bf7\u7a0d\u540e\u518d\u8bd5\u3002', 'de': 'Anfragelimit erreicht. Versuche es sp\u00e4ter erneut.'});

  // \u2500\u2500 Profile (\u00ab\u0430\u043d\u043a\u0435\u0442\u0430\u00bb, standalone) \u2500\u2500
  String get profileTitle => _t({'ru': '\u041f\u0440\u043e\u0444\u0438\u043b\u044c', 'en': 'Profile', 'es': 'Perfil', 'zh': '\u4e2a\u4eba\u8d44\u6599', 'de': 'Profil'});
  String get profileHelper => _t({'ru': 'Jarvis \u0431\u0443\u0434\u0435\u0442 \u043e\u0431\u0440\u0430\u0449\u0430\u0442\u044c\u0441\u044f \u043f\u0440\u0430\u0432\u0438\u043b\u044c\u043d\u043e. \u0412\u0441\u0435 \u043f\u043e\u043b\u044f \u043c\u043e\u0436\u043d\u043e \u043e\u0441\u0442\u0430\u0432\u0438\u0442\u044c \u043f\u0443\u0441\u0442\u044b\u043c\u0438.', 'en': 'Jarvis will address you properly. All fields are optional.', 'es': 'Jarvis se dirigir\u00e1 a ti correctamente. Todos los campos son opcionales.', 'zh': 'Jarvis \u4f1a\u6b63\u786e\u79f0\u547c\u4f60\u3002\u6240\u6709\u5b57\u6bb5\u5747\u53ef\u7559\u7a7a\u3002', 'de': 'Jarvis spricht dich richtig an. Alle Felder sind optional.'});
  String get profileName => _t({'ru': '\u0418\u043c\u044f', 'en': 'Name', 'es': 'Nombre', 'zh': '\u540d\u5b57', 'de': 'Name'});
  String get profileGender => _t({'ru': '\u041f\u043e\u043b', 'en': 'Gender', 'es': 'G\u00e9nero', 'zh': '\u6027\u522b', 'de': 'Geschlecht'});
  String get genderMale => _t({'ru': '\u041c\u0443\u0436\u0441\u043a\u043e\u0439', 'en': 'Male', 'es': 'Masculino', 'zh': '\u7537', 'de': 'M\u00e4nnlich'});
  String get genderFemale => _t({'ru': '\u0416\u0435\u043d\u0441\u043a\u0438\u0439', 'en': 'Female', 'es': 'Femenino', 'zh': '\u5973', 'de': 'Weiblich'});
  String get profileOccupation => _t({'ru': '\u0420\u043e\u0434 \u0437\u0430\u043d\u044f\u0442\u0438\u0439', 'en': 'Occupation', 'es': 'Ocupaci\u00f3n', 'zh': '\u804c\u4e1a', 'de': 'Beruf'});
  String get profileCity => _t({'ru': '\u0413\u043e\u0440\u043e\u0434', 'en': 'City', 'es': 'Ciudad', 'zh': '\u57ce\u5e02', 'de': 'Stadt'});
  String get profileAge => _t({'ru': '\u0412\u043e\u0437\u0440\u0430\u0441\u0442', 'en': 'Age', 'es': 'Edad', 'zh': '\u5e74\u9f84', 'de': 'Alter'});
  String get profileSaved => _t({'ru': '\u041f\u0440\u043e\u0444\u0438\u043b\u044c \u0441\u043e\u0445\u0440\u0430\u043d\u0451\u043d', 'en': 'Profile saved', 'es': 'Perfil guardado', 'zh': '\u4e2a\u4eba\u8d44\u6599\u5df2\u4fdd\u5b58', 'de': 'Profil gespeichert'});

  // \u2500\u2500 My Agents (standalone) \u2500\u2500
  String get myAgentsTitle => _t({'ru': '\u041c\u043e\u0438 \u0430\u0433\u0435\u043d\u0442\u044b', 'en': 'My agents', 'es': 'Mis agentes', 'zh': '\u6211\u7684\u667a\u80fd\u4f53', 'de': 'Meine Agenten'});
  String get myAgentsEmpty => _t({'ru': '\u041f\u043e\u043a\u0430 \u043d\u0435\u0442 \u0430\u0433\u0435\u043d\u0442\u043e\u0432 \u2014 \u043f\u043e\u0434\u0435\u043b\u0438\u0441\u044c \u0441\u0441\u044b\u043b\u043a\u043e\u0439 \u0441 \u0434\u0440\u0443\u0433\u043e\u043c \u0438\u043b\u0438 \u0438\u043c\u043f\u043e\u0440\u0442\u0438\u0440\u0443\u0439', 'en': 'No agents yet \u2014 share a link with a friend or import one', 'es': 'A\u00fan no hay agentes \u2014 comparte un enlace con un amigo o importa uno', 'zh': '\u8fd8\u6ca1\u6709\u667a\u80fd\u4f53 \u2014 \u4e0e\u670b\u53cb\u5206\u4eab\u94fe\u63a5\u6216\u5bfc\u5165\u4e00\u4e2a', 'de': 'Noch keine Agenten \u2014 teile einen Link mit einem Freund oder importiere einen'});
  String get myAgentsError => _t({'ru': '\u041d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044c \u0430\u0433\u0435\u043d\u0442\u043e\u0432', 'en': 'Couldn\'t load your agents', 'es': 'No se pudieron cargar tus agentes', 'zh': '\u65e0\u6cd5\u52a0\u8f7d\u4f60\u7684\u667a\u80fd\u4f53', 'de': 'Agenten konnten nicht geladen werden'});
  // Reminder agent controls (toggle + next-fire + snooze + permission).
  String reminderNextFire(String time) => _t({'ru': '\u0421\u043b\u0435\u0434\u0443\u044e\u0449\u0435\u0435: $time', 'en': 'Next: $time', 'es': 'Pr\u00f3ximo: $time', 'zh': '\u4e0b\u6b21: $time', 'de': 'N\u00e4chste: $time'});
  String get reminderNextFireNone => _t({'ru': '\u041d\u0435\u0442 \u0431\u043b\u0438\u0436\u0430\u0439\u0448\u0438\u0445 \u043d\u0430\u043f\u043e\u043c\u0438\u043d\u0430\u043d\u0438\u0439', 'en': 'No upcoming reminders', 'es': 'Sin pr\u00f3ximos recordatorios', 'zh': '\u6ca1\u6709\u5373\u5c06\u5230\u6765\u7684\u63d0\u9192', 'de': 'Keine anstehenden Erinnerungen'});
  String get reminderSnoozeHour => _t({'ru': '\u041e\u0442\u043b\u043e\u0436\u0438\u0442\u044c \u043d\u0430 \u0447\u0430\u0441', 'en': 'Snooze for an hour', 'es': 'Posponer una hora', 'zh': '\u63a8\u8fdf\u4e00\u5c0f\u65f6', 'de': 'Eine Stunde verschieben'});
  String get reminderSnoozed => _t({'ru': '\u041e\u0442\u043b\u043e\u0436\u0435\u043d\u043e \u043d\u0430 \u0447\u0430\u0441', 'en': 'Snoozed for an hour', 'es': 'Pospuesto una hora', 'zh': '\u5df2\u63a8\u8fdf\u4e00\u5c0f\u65f6', 'de': 'Um eine Stunde verschoben'});
  String get reminderPermissionNeeded => _t({'ru': '\u041d\u0443\u0436\u043d\u043e \u0440\u0430\u0437\u0440\u0435\u0448\u0435\u043d\u0438\u0435 \u043d\u0430 \u0443\u0432\u0435\u0434\u043e\u043c\u043b\u0435\u043d\u0438\u044f', 'en': 'Notification permission is required', 'es': 'Se requiere permiso de notificaciones', 'zh': '\u9700\u8981\u901a\u77e5\u6743\u9650', 'de': 'Benachrichtigungsberechtigung erforderlich'});
  String get save => _t({'ru': '\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c', 'en': 'Save', 'es': 'Guardar', 'zh': '\u4fdd\u5b58', 'de': 'Speichern'});
