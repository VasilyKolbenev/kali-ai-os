...
## Усиление питча — из Anthropic Founder's Playbook (2026)

Источник: «The Founder's Playbook: Building an AI-Native Startup». Это язык, на
котором инвесторы 2026 думают о ранних стартапах — говори в нём.

### 1. Нарратив «founder = orchestrator of agents» (твоя суперсила)
Плейбук прямо: в AI-native стартапе основатель — не исполнитель, а оркестратор
AI-агентов; lean-команда делает работу большой. **Это буквально ты** — соло
строишь продукт уровня команды. Скажи это вслух: «я один, с AI-инфраструктурой,
за месяцы собрал то, на что раньше нужна была команда инженеров». Сильный сигнал
капитал-эффективности.

### 2. Problem-solution fit одной фразой (их формат)
Не «людям нужен голосовой ИИ» (наблюдение), а **тестируемая гипотеза**:
> «Непрог 30+ (строитель/врач/таксист) НЕ может автоматизировать рутину, потому
> что все инструменты требуют кода или настройки; KALI даёт это голосом, локально».
Подготовь свою версию с конкретикой: кто, как часто, насколько остро, что делает
сейчас.

### 3. Готовь ответ про измерение (плейбук жёстко: метрики ДО запуска)
Инвестор спросит «как меряете успех / трекшн». Назови воронку KALI:
- **Активация:** % установивших, кто создал ≥1 агента голосом.
- **Удержание:** вернулся на 7-й / 30-й день.
- **UGC / K-фактор:** % поделившихся скиллом → друзья установили.
- **Что НЕ считается успехом** (анти-самообман): установка без активации,
  всплеск от друзей вместо органики.
Даже без данных — назвать рамку = выглядишь как оператор, а не мечтатель.

### 4. Опереди «false PMF» сам
Плейбук: красивое демо ≠ product-market fit; ранний всплеск (друзья, HN) не
предсказывает 6-12 неделю. Скажи честно: «у нас сильное демо и работающий
продукт; PMF мы доказываем удержанием в закрытой бете — вот план измерения».
Честность тут читается как зрелость.

### 5. Devil's advocate перед встречей (их core-приём)
Прогони питч против себя: «почему конкурент победит, а мы нет», «почему это не
PMF». Мы это умеем (generator→validator). Лучше найти дыры самим, чем на сцене.

### 6. Анти-скоуп-крип как дисциплина (плюс в глазах инвестора)
У нас есть written scope + анти-пивот правило (NO dev/design turf). Это ровно
то, что плейбук советует против «zero-friction scope creep». Покажи, что режешь
осознанно — признак сфокусированного основателя.
